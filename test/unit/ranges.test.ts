...
describe('test valid ranges', () => {
  for (const { range, included, excluded } of [
    { range: 'v1.0.0', included: [ 'v1.0.0' ], excluded: [ 'v0.0.0', 'v1.0.1', 'v2.0.0' ] },
    { range: '[v1.0.0]', included: [ 'v1.0.0' ], excluded: [ 'v0.0.0', 'v1.0.1', 'v2.0.0' ] },
    { range: '[v1.0.0,v1.0.0]', included: [ 'v1.0.0' ], excluded: [ 'v0.0.0', 'v1.0.1', 'v2.0.0' ] },
    { range: '[v1.0.0, v1.0.0]', included: [ 'v1.0.0' ], excluded: [ 'v0.0.0', 'v1.0.1', 'v2.0.0' ] },
    { range: '[v1.0.0,]', included: [ 'v1', 'v1.0.0', 'v1.0.1', 'v2' ], excluded: [ 'v0.0.0', 'v0.0.1', 'v0.1.0' ] },
    { range: '[v1.0.0,)', included: [ 'v1', 'v1.0.0', 'v1.0.1', 'v2' ], excluded: [ 'v0.0.0', 'v0.0.1', 'v0.1.0' ] },
    { range: '(v1.0.0,)', included: [ 'v1.0.1', 'v2' ], excluded: [ 'v0.0.0', 'v0.1.1', 'v1', 'v1.0.0' ] },
    { range: '[v1.0.1, v2.1.1]', included: [ 'v1.0.1', 'v1.1.1', 'v2.0.0', 'v2.0.1', 'v2.1.0', 'v2.1.1' ], excluded: [ 'v0.0.0', 'v1.0.0', 'v3', 'v10.0.0' ] },
    { range: '(v1.0.1, v2.1.1)', included: [ 'v1.0.2', 'v2.1.0' ], excluded: [ 'v1.0.0', 'v1.0.1', 'v2.1.1' ] },
    { range: '(,v2.0.0-pre]', included: [ 'v1', 'v2.0.0-alpha', 'v2.0.0-pre' ], excluded: [ 'v2.0.0-rc', 'v2.0.0' ] },
    { range: '[v1.0.0-20201219133700-deadbeef, v1.0.0-20201219133702-deadbeef]',
      included: ['v1.0.0-20201219133700-deadbeef', 'v1.0.0-20201219133701-deadbeef', 'v1.0.0-20201219133702-deadbeef'],
      excluded: ['v1.0.0', 'v1.0.1', 'v1.0.0-alpha', 'v1.0.0-20201219133600-deadbeef', 'v1.0.0-20201219133703-deadbeef' ],
    },
    { range: '[v0, v1]', included: [], excluded: [ 'v1.0.0-20200202222222-deadbeef' ]},
    { range: '[v0, v1.1.1-pre]', included: [ 'v1.1.0-pre.0.20200202222222-deadbeef' ], excluded: [ 'v1.1.1-pre.0.20200202222222-deadbeef' ]},
    { range: '[v0, v1.1.1]', included: [ 'v1.1.1-20200202222222-deadbeef' ], excluded: [ 'v1.1.2-20200202222222-deadbeef' ] },
  ]) {
